...
INSERT INTO `Pokedex` VALUES (1,'Pikachu','Impactrueno*40*20*Ataque eléctrico rápido',35,4,5,0,'FASE1(1)','Ratón eléctrico veloz'),(2,'Charmander','Ascuas*30*15*Llamas débiles',39,1,2,6,'FASE1(2),FASE2(5),FASE3(6)','Lagarto de fuego'),(3,'Squirtle','Pistola Agua*35*15*Chorro de agua',44,2,4,1,'FASE1(3),FASE2(8),FASE3(9)','Tortuga acuática'),(4,'Gyarados','Canonazo*40*20*Ataque acuatico eficaz',60,2,4,8,'Fase1(1)','Lagarto acuatico gigante'),(5,'Onix','Pedrolo*40*20*Ataque piedra eficaz',60,5,2,8,'Fase1(1)','Lagarto de piedra gigante'),(6,'Bulbasaur','Latigazo*30*20*Ataque latigo rapido',40,2,4,8,'Fase1(1)','Planta con vida'),(7,'Celebi','PistolaSol*80*20*Pistolazo',90,2,4,8,'Fase1(1)','Planta viviente que viaja en el tiempo'),(8,'Charizard','Llamarada*70*30*Llamarada de fuego',80,1,3,8,'Fase1(1)','Dragon de fuego'),(9,'Blastoise','Pistola Agua*70*30*Pistolazo',80,3,2,8,'Fase1(1)','Tortuga marina gigante');
